...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while(playerHealth>0 && dragonHealth>0) {    //this line of code keeps the battle going until someone's health reaches 0 
			...
			String attack = JOptionPane.showInputDialog("do you want to attack dragon with a kick or yell");
			// 9. If they typed in "yell":
			if (attack.equals("yell")) {
				//-- Find a random number between 0 and 10 and store it in dragonDamage
				ddamage = new Random().nextInt(20);
			...
			// 10. If they typed in "kick":
				...
				ddamage = new Random().nextInt(35);
				//-- Subtract that number from the dragon's health variable
				dragonHealth = dragonHealth - ddamage;
			}
				
			// 11.  Find a random number between 0 and 35 and store it in playerDamage
			pdamage = new Random().nextInt(35);
			...
			if (playerHealth <= 0) {
				...
				JOptionPane.showMessageDialog(null, "you lost to the dragon");
			}
